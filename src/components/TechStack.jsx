...
const TechStack = () => {
  return (
    <div className="w-full flex flex-col bg-black p-6 gap-4 md:gap-8 items-center">
      <div>
        <p className="text-white/90 text-xl font-bold my-2 md:text-3xl">
          Tech Stack
        </p>
      </div>
      <div className="w-full flex place-items-center gap-4 flex-wrap justify-center sm:grid sm:grid-cols-3 sm:grid-flow-row sm:gap-8 sm:max-w-[80%]  md:flex md:max-w-full">
